...
class MetadataMatch(Base):
    ...
    provider: Mapped[str] = mapped_column(String, index=True) # e.g. "tmdb", "stashdb", "anilist", "r18", "mal"
    external_id: Mapped[str] = mapped_column(String, index=True)
    provider_ids: Mapped[Optional[dict[str, str]]] = mapped_column(JSON, nullable=True) # e.g. {"mal": "12345", "anidb": "6789", "r18": "SSIS-001"}
    media_type: Mapped[str] = mapped_column(String, index=True, default="movie") # e.g. "movie", "tv", "episode", "anime", "jav", "clip"
