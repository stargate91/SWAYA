    ...
    def get_watched_history(
        ...
        for log in logs:
            ...
            results.append({
                ...
                "poster_path": resolve_img_fn(loc.poster_path if loc else None, "posters"),
                "backdrop_path": resolve_img_fn(active_match.backdrop_path if active_match else None, "backdrops"),
