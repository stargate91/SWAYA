...
class BaseFilmographyStrategy:
    ...
    def get_strategy(source: str, scrapers: Any, db: Session) -> "BaseFilmographyStrategy":
        from app.domains.people.services.filmography.strategies.stashdb_strategy import StashDbFilmographyStrategy
        from app.domains.people.services.filmography.strategies.porndb_strategy import PornDbFilmographyStrategy
