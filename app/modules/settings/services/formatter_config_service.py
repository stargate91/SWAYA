...
from app.modules.library.services.formatter.config import Casing, FormatterConfig, Separator
...
def build_formatter_from_db(db_session, user_id: int = 1):
    from app.modules.library.services.formatter.formatter import Formatter
