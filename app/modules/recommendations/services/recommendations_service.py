...
class RecommendationsService:
    def __init__(self, db: Session, scrapers: Any, settings: Optional[Any] = None):
        ...
        from app.modules.recommendations.services.library_content_service import LibraryContentService
        from app.modules.recommendations.services.tmdb_recommendation_service import TmdbRecommendationService
