...
from app.modules.scrapers.resolvers.adult.stashdb_resolver import HASH_QUERY, SEARCH_QUERY

logger = logging.getLogger(__name__)

class FansDbResolver:
    """
    Submodule to resolve matches from FansDB API.
    """
    def __init__(self, scraper):
        self.scraper = scraper
        self.provider = Provider.FANSDB

    def is_configured(self) -> bool:
        return bool(self.scraper.get_setting('fansdb_api_key'))
