...
class BaseStashGraphQLResolver:
    def __init__(self, scraper, provider: Provider, setting_keys: List[str]):
        self.scraper = scraper
        self.provider = provider
        self.setting_keys = setting_keys

    def is_configured(self) -> bool:
        return any(bool(self.scraper.get_setting(key)) for key in self.setting_keys)
