...
from app.modules.scrapers.enrichment.tmdb_parser import TMDBEnrichmentParser
from app.modules.scrapers.enrichment.omdb_parser import OMDBEnrichmentParser
