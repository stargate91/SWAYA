...
from app.modules.library.adapters.db_media_item_adapter import DbMediaItemAdapter
from app.modules.library.adapters.db_rename_adapter import DbRenameAdapter
from app.modules.library.adapters.db_scan_adapter import DbScanAdapter
from app.modules.library.adapters.db_person_override_adapter import DbPersonOverrideAdapter
from app.modules.library.adapters.db_playback_adapter import DbPlaybackAdapter
from app.modules.library.adapters.db_collection_adapter import DbCollectionAdapter
...
class DbMediaResolver(
    ...
    def __init__(self, db: Session):
        self.db = db
        super().__init__()
        from app.modules.library.adapters.structure.structure_updater import StructureUpdater
