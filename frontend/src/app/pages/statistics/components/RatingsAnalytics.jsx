    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)', width: '100%' }}>
        {Array.from({ length: 3 }).map((_, idx) => (
          <div key={idx} style={{ padding: 'var(--space-xl)', background: 'var(--color-panel-soft)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-border-default)', minHeight: '120px' }}>
...
export function RatingDistribution({
  ...
  if (state.isStatsLoading) {
    return (
      <div style={{ padding: 'var(--space-xl)', background: 'var(--color-panel-soft)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-border-default)', minHeight: '340px', width: '100%' }}>
