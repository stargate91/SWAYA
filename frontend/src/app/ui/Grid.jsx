 ...
 * @param {'poster' | 'scene' | 'backdrop' | 'logo' | 'mixed' | 'auto-poster' | 'auto-scene' | 'stats' | 'bento' | 'split' | 'auto-card' | 'tags' | 'picker' | 'default'} [props.variant] - The type/variant of the grid layout
